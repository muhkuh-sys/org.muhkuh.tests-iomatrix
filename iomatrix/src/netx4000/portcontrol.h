...
#define MSK_PORTCONTROL_INDEX_MINOR         0x000fU
#define SRT_PORTCONTROL_INDEX_MINOR         0U
#define MSK_PORTCONTROL_INDEX_MAJOR         0x0ff0U
#define SRT_PORTCONTROL_INDEX_MAJOR         4U

#define MSK_PORTCONTROL_CONFIGURATION_UDC   0x0003U
#define SRT_PORTCONTROL_CONFIGURATION_UDC   0U
#define MSK_PORTCONTROL_CONFIGURATION_DRV   0x0030U
#define SRT_PORTCONTROL_CONFIGURATION_DRV   4U
#define MSK_PORTCONTROL_CONFIGURATION_CTL   0x0f00U
#define SRT_PORTCONTROL_CONFIGURATION_CTL   8U
#define MSK_PORTCONTROL_CONFIGURATION_SEL   0x7000U
#define SRT_PORTCONTROL_CONFIGURATION_SEL   12U
...
#define REEMUX_DRV_04MA  0U
#define REEMUX_DRV_06MA  1U
#define REEMUX_DRV_08MA  2U
#define REEMUX_DRV_12MA  3U


#define REEMUX_UDC_NONE         0U
#define REEMUX_UDC_PULLUP50K    1U
#define REEMUX_UDC_NONE2        2U
#define REEMUX_UDC_PULLDOWN50K  3U
